...
namespace CafeManagementSystem {
    ...
    public partial class CafeDBDataSet : global::System.Data.DataSet {
        ...
        public partial class ItemDataTable : global::System.Data.TypedTableBase<ItemRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ItemRow AddItemRow(int No, string Name, string Category, decimal Price) {
        ...
        public partial class ItemRow : global::System.Data.DataRow {
            ...
            public int No {
                get {
                    return ((int)(this[this.tableItem.NoColumn]));
                }
                set {
...
namespace CafeManagementSystem.CafeDBDataSetTableAdapters {
    ...
    public partial class ItemTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Item] WHERE (([Id] = @Original_Id) AND ([No] = @Original_No) A" +
                "ND ([Name] = @Original_Name) AND ([Category] = @Original_Category) AND ([Price] " +
                "= @Original_Price))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Item] ([No], [Name], [Category], [Price]) VALUES (@No, @Name, " +
                "@Category, @Price);\r\nSELECT Id, No, Name, Category, Price FROM Item WHERE (Id = " +
                "SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Item] SET [No] = @No, [Name] = @Name, [Category] = @Category, [Price] = @Price WHERE (([Id] = @Original_Id) AND ([No] = @Original_No) AND ([Name] = @Original_Name) AND ([Category] = @Original_Category) AND ([Price] = @Original_Price));
SELECT Id, No, Name, Category, Price FROM Item WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, No, Name, Category, Price FROM dbo.Item";
        ...
        public virtual int Fill(CafeDBDataSet.ItemDataTable dataTable) {
        ...
        public virtual CafeDBDataSet.ItemDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CafeDBDataSet.ItemDataTable dataTable = new CafeDBDataSet.ItemDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CafeDBDataSet.ItemDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, int Original_No, string Original_Name, string Original_Category, decimal Original_Price) {
        ...
        public virtual int Insert(int No, string Name, string Category, decimal Price) {
        ...
        public virtual int Update(int No, string Name, string Category, decimal Price, int Original_Id, int Original_No, string Original_Name, string Original_Category, decimal Original_Price, int Id) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int No, string Name, string Category, decimal Price, int Original_Id, int Original_No, string Original_Name, string Original_Category, decimal Original_Price) {
            return this.Update(No, Name, Category, Price, Original_Id, Original_No, Original_Name, Original_Category, Original_Price, Original_Id);
        }
    }
